...
class JobOrder extends Model
{
    ...
    {
        return $this->belongsTo(Branch::class, 'processing_branch_id');
    }
    ...
    public function poTransaction()
    {
        return $this->hasOne(PoTransaction::class);
    }

    public function cycles()
    {
        return $this->hasMany(CycleRecord::class);
    }
    ...
    {
        return $query->where($query->getModel()->qualifyColumn('status'), '!=', 'cancelled');
    }
