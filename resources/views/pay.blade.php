...
a:focus-visible,summary:focus-visible{outline:2px solid var(--aqua);outline-offset:3px;border-radius:6px;}
...
<main class="card">
    ...
    <section class="pitch">
        ...
        <div class="chips">
            ...
            <div class="chip">
                <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="10" width="16" height="11" rx="2"/><path d="M8 10V7a4 4 0 0 1 8 0v3"/></svg>
                Bank-grade security
            </div>
            <div class="chip">
                <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="7" y="2" width="10" height="20" rx="2.5"/><path d="M11 18h2"/></svg>
                Any QRPH app
            </div>
            <div class="chip">
    ...
    <section class="paper">
        ...
        <div class="qr">
            <b></b><b></b><b></b><b></b>
            <img src="{{ asset('uploads/pay.png') }}" alt="QR code for paying Spin Klean Laundry JP">
        </div>
...
<script>
    // Steps stay open on wide screens, collapsed on phones to keep the QR above the fold.
